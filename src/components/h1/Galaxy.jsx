...
export default function Galaxy({ data }) {
    ...
    const cyborgs = generateScore(
        json.campaign_status[1].points,
        json.campaign_status[1].points_max,
    );

    const illuminate = generateScore(
    ...
    return (
        <section id="map" className="max-w-2/3 z-40 aspect-square max-h-[80vh] w-full">
            <div
                id="map__hover"
                className={
                    hover ?
            ...
            >
                ...
                <g id="bugs">
                    ...
                    <path
                        id="0-11"
                        data-name="11"
                        className={bugs[11] ? 'sector ' + bugs[11] : 'lost'}
                ...
                <g id="cyborgs">
                    ...
                    <path
                        id="1-11"
                        data-name="11"
                        className={cyborgs[11] ? 'sector ' + cyborgs[11] : 'lost'}
                ...
                <g id="illuminate">
                    ...
                    <path
                        id="2-11"
                        data-name="11"
                        className={illuminate[11] ? 'sector ' + illuminate[11] : 'lost'}
