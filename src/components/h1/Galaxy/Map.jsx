                ...
                >
                    ...
                    <g id="bugs">
                        <path
                            ...
                            data-name="1"
                            data-faction="bugs"
                            className={'sector ' + map[bugs][1].status}
                        ...
                        <path
                            id="0-2"
                            data-name="2"
                            className={'sector ' + map[bugs][2].status}
                        ...
                        <path
                            id="0-3"
                            data-name="3"
                            className={'sector ' + map[bugs][3].status}
                        ...
                        <path
                            id="0-4"
                            data-name="4"
                            className={'sector ' + map[bugs][4].status}
                        ...
                        <path
                            id="0-5"
                            data-name="5"
                            className={'sector ' + map[bugs][5].status}
                        ...
                        <path
                            id="0-6"
                            data-name="6"
                            className={'sector ' + map[bugs][6].status}
                        ...
                        <path
                            id="0-7"
                            data-name="7"
                            className={'sector ' + map[bugs][7].status}
                        ...
                        <path
                            id="0-8"
                            data-name="8"
                            className={'sector ' + map[bugs][8].status}
                        ...
                        <path
                            id="0-9"
                            data-name="9"
                            className={'sector ' + map[bugs][9].status}
                        ...
                        <path
                            id="0-10"
                            data-name="10"
                            className={'sector ' + map[bugs][10].status}
                    ...
                    <g id="cyborgs">
                        <path
                            id="1-1"
                            data-name="1"
                            className={'sector ' + map[cyborgs][1].status}
                        ...
                        <path
                            id="1-2"
                            data-name="2"
                            className={'sector ' + map[cyborgs][2].status}
                        ...
                        <path
                            id="1-3"
                            data-name="3"
                            className={'sector ' + map[cyborgs][3].status}
                        ...
                        <path
                            id="1-4"
                            data-name="4"
                            className={'sector ' + map[cyborgs][4].status}
                        ...
                        <path
                            id="1-5"
                            data-name="5"
                            className={'sector ' + map[cyborgs][5].status}
                        ...
                        <path
                            id="1-6"
                            data-name="6"
                            className={'sector ' + map[cyborgs][6].status}
                        ...
                        <path
                            id="1-7"
                            data-name="7"
                            className={'sector ' + map[cyborgs][7].status}
                        ...
                        <path
                            id="1-8"
                            data-name="8"
                            className={'sector ' + map[cyborgs][8].status}
                        ...
                        <path
                            id="1-9"
                            data-name="9"
                            className={'sector ' + map[cyborgs][9].status}
                        ...
                        <path
                            id="1-10"
                            data-name="10"
                            className={'sector ' + map[cyborgs][10].status}
                    ...
                    <g id="illuminate">
                        <path
                            id="2-1"
                            data-name="1"
                            className={'sector ' + map[illuminate][1].status}
                        ...
                        <path
                            id="2-2"
                            data-name="2"
                            className={'sector ' + map[illuminate][2].status}
                        ...
                        <path
                            id="2-3"
                            data-name="3"
                            className={'sector ' + map[illuminate][3].status}
                        ...
                        <path
                            id="2-4"
                            data-name="4"
                            className={'sector ' + map[illuminate][4].status}
                        ...
                        <path
                            id="2-5"
                            data-name="5"
                            className={'sector ' + map[illuminate][5].status}
                        ...
                        <path
                            id="2-6"
                            data-name="6"
                            className={'sector ' + map[illuminate][6].status}
                        ...
                        <path
                            id="2-7"
                            data-name="7"
                            className={'sector ' + map[illuminate][7].status}
                        ...
                        <path
                            id="2-8"
                            data-name="8"
                            className={'sector ' + map[illuminate][8].status}
                        ...
                        <path
                            id="2-9"
                            data-name="9"
                            className={'sector ' + map[illuminate][9].status}
                        ...
                        <path
                            id="2-10"
                            data-name="10"
                            className={'sector ' + map[illuminate][10].status}
